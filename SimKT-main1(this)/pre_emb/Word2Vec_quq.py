...
def learn_embeddings(walks):
    ...
    # model = Word2Vec(walks, size=args.dim, window=args.windowSize, min_count=0, sg=1, workers=args.workers, iter=args.iter,)
    model = Word2Vec(walks, size=args.dim, window=args.windowSize, min_count=0, sg=1, workers=args.workers,
                     iter=args.iter,)
...
if __name__ == "__main__":
    ...
    save_folder = "E:/Study/SimKT/SimKT/pre_emb/%s/emb" % data_set
